...
- CLAUDE.md의 절대 원칙(특히 "관리자 기능 **5종** 한정", "포인트=시뮬레이션만")을 데이터 설계 단계에서부터 지킵니다. 5종은 프로그램 관리 / 담당 학생 아카이브 조회 / QR 스캔 / 담당 해제(ADR 0015) / 비밀번호 초기화(ADR 0019)이며, 세는 단위는 관리자가 수행하는 **동작**입니다.
